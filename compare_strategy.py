...
from strategy import SimpleGreedyStrategy, AdaptiveStrategy, run_strategy, TrendSwitchStrategy
...
def main():
    strategies = [SimpleGreedyStrategy, AdaptiveStrategy, TrendSwitchStrategy]
    results = []
